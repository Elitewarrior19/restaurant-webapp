...
export default function SignupPage() {
  ...
  return (
    <div className="mx-auto max-w-sm space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-charcoal">Create account</h1>
        <p className="mt-1 text-sm text-gray-500">
          Save your orders, addresses & reorder in seconds.
        </p>
      </div>
      ...
      <p className="text-center text-sm text-gray-500">
        ...
        <Link href="/login" className="font-medium text-saffron hover:underline">
          Log in
        </Link>
      </p>
    </div>
